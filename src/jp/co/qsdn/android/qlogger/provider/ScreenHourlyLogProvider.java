...
public class ScreenHourlyLogProvider
  ...
  public static final String AUTHORITY = "jp.co.qsdn.android.qlogger.provider.ScreenHourlyLog";
  ...
  public static class COLUMN_INDEX {
    ...
    public static final int HH24               = 3;
    public static final int CREATED_ON_LONG    = 4;
    public static final int CREATED_ON         = 5;
  }

  public static final int SCREEN_HOURLY_LOGS                   = 0;
  public static final int SCREEN_HOURLY_LOG_ID                 = 1;
  public static final int SCREEN_HOURLY_LOGS_GROUP_BY_YYYYMMDD = 2;
  public static final int SCREEN_HOURLY_LOGS_BY_YYYYMMDD       = 3;

  protected static final String TABLE_NAME = "screen_hourly_log";
  ...
  static {
    uriMatcher.addURI(AUTHORITY, "logs", SCREEN_HOURLY_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/#", SCREEN_HOURLY_LOG_ID);
    uriMatcher.addURI(AUTHORITY, "logs" + GROUP_BY.YYYYMMDD, SCREEN_HOURLY_LOGS_GROUP_BY_YYYYMMDD);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd", SCREEN_HOURLY_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd/#", SCREEN_HOURLY_LOGS_BY_YYYYMMDD);
  };

  public ScreenHourlyLogProvider() {
    dbHelper = null;
  }
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    case SCREEN_HOURLY_LOGS:
    case SCREEN_HOURLY_LOGS_GROUP_BY_YYYYMMDD:
      ret = dbHelper.getWritableDatabase().delete(TABLE_NAME, selection, selectionArgs);
      break;

    case SCREEN_HOURLY_LOG_ID:
      {
    ...
    case SCREEN_HOURLY_LOGS_BY_YYYYMMDD:
      {
  ...
  public String getType(Uri uri) {
    ...
    case SCREEN_HOURLY_LOGS_GROUP_BY_YYYYMMDD:
    case SCREEN_HOURLY_LOGS_BY_YYYYMMDD:
      return "vnd.android.cursor.dir/vnd.qsdn.screenhourlylog";

    case SCREEN_HOURLY_LOG_ID:
      return "vnd.android.cursor.item/vnd.qsdn.screenhourlylog";
  ...
  public Uri insert(Uri uri, ContentValues contentValues) {
    ...
    if (uriMatcher.match(uri) == SCREEN_HOURLY_LOG_ID) {
      throw new IllegalArgumentException("Unknown URI " + uri);
    }
    ...
    if (!contentValues.containsKey(COLUMN_NAME.HH24)) {
      if (contentValues.containsKey(COLUMN_NAME.CREATED_ON)) {
        String strTime = (String)contentValues.get(COLUMN_NAME.CREATED_ON);
        if (!TextUtils.isEmpty(strTime)) {
          Timestamp tmp = Timestamp.valueOf(strTime);
          contentValues.put(COLUMN_NAME.HH24, hh24Format.format(tmp.getTime()));
        }
        else {
          contentValues.put(COLUMN_NAME.HH24, hh24Format.format(System.currentTimeMillis()));
        }
      }
      else {
        contentValues.put(COLUMN_NAME.HH24, hh24Format.format(System.currentTimeMillis()));
