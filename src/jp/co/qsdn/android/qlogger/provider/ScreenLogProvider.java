...
public class ScreenLogProvider
  ...
  public static final String AUTHORITY = "jp.co.qsdn.android.qlogger.provider.ScreenLog";
  ...
  public static final int SCREEN_LOGS = 0;
  public static final int SCREEN_LOG_ID = 1;
  public static final int SCREEN_LOGS_GROUP_BY_YYYYMMDD = 2;
  public static final int SCREEN_LOGS_BY_YYYYMMDD = 3;

  protected static final String TABLE_NAME = "screen_log";
  ...
  static {
    uriMatcher.addURI(AUTHORITY, "logs", SCREEN_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/#", SCREEN_LOG_ID);
    uriMatcher.addURI(AUTHORITY, "logs" + GROUP_BY.YYYYMMDD, SCREEN_LOGS_GROUP_BY_YYYYMMDD);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd", SCREEN_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd/#", SCREEN_LOGS_BY_YYYYMMDD);
  };

  public ScreenLogProvider() {
    dbHelper = null;
  }
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    case SCREEN_LOGS:
    case SCREEN_LOGS_GROUP_BY_YYYYMMDD:
  ...
  public String getType(Uri uri) {
    ...
    case SCREEN_LOGS_GROUP_BY_YYYYMMDD:
    case SCREEN_LOGS_BY_YYYYMMDD:
      return "vnd.android.cursor.dir/vnd.qsdn.screenlog";

    case SCREEN_LOG_ID:
      return "vnd.android.cursor.item/vnd.qsdn.screenlog";
  ...
  public Uri insert(Uri uri, ContentValues contentValues) {
    ...
    if (uriMatcher.match(uri) == SCREEN_LOG_ID) {
      throw new IllegalArgumentException("Unknown URI " + uri);
    }
