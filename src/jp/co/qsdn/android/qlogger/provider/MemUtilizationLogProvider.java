...
public class MemUtilizationLogProvider
  ...
  public static final String AUTHORITY = "jp.co.qsdn.android.qlogger.provider.MemUtilizationLog";
  ...
  public static final int MEM_UTILIZATION_LOGS                   = 0;
  public static final int MEM_UTILIZATION_LOG_ID                 = 1;
  public static final int MEM_UTILIZATION_LOGS_GROUP_BY_YYYYMMDD = 2;
  public static final int MEM_UTILIZATION_LOGS_BY_YYYYMMDD       = 3;

  protected static final String TABLE_NAME = "mem_utilization_log";
  ...
  static {
    uriMatcher.addURI(AUTHORITY, "logs", MEM_UTILIZATION_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/#", MEM_UTILIZATION_LOG_ID);
    uriMatcher.addURI(AUTHORITY, "logs" + GROUP_BY.YYYYMMDD, MEM_UTILIZATION_LOGS_GROUP_BY_YYYYMMDD);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd", MEM_UTILIZATION_LOGS);
    uriMatcher.addURI(AUTHORITY, "logs/yyyymmdd/#", MEM_UTILIZATION_LOGS_BY_YYYYMMDD);
  };

  public MemUtilizationLogProvider() {
    dbHelper = null;
  }
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    case MEM_UTILIZATION_LOGS:
    case MEM_UTILIZATION_LOGS_GROUP_BY_YYYYMMDD:
      ret = dbHelper.getWritableDatabase().delete(TABLE_NAME, selection, selectionArgs);
      break;

    case MEM_UTILIZATION_LOG_ID:
      {
    ...
    case MEM_UTILIZATION_LOGS_BY_YYYYMMDD:
      {
  ...
  public String getType(Uri uri) {
    ...
    case MEM_UTILIZATION_LOGS_GROUP_BY_YYYYMMDD:
    case MEM_UTILIZATION_LOGS_BY_YYYYMMDD:
      return "vnd.android.cursor.dir/vnd.qsdn.memutilizationlog";

    case MEM_UTILIZATION_LOG_ID:
      return "vnd.android.cursor.item/vnd.qsdn.memutilizationlog";
  ...
  public Uri insert(Uri uri, ContentValues contentValues) {
    ...
    if (uriMatcher.match(uri) == MEM_UTILIZATION_LOG_ID) {
      throw new IllegalArgumentException("Unknown URI " + uri);
    }
    ...
    if (!contentValues.containsKey(COLUMN_NAME.TOTAL)) {
      contentValues.put(COLUMN_NAME.TOTAL, 0);
    }
    if (!contentValues.containsKey(COLUMN_NAME.FREE)) {
      contentValues.put(COLUMN_NAME.FREE, 0);
    }
    if (!contentValues.containsKey(COLUMN_NAME.CACHE)) {
      contentValues.put(COLUMN_NAME.CACHE, 0);
    }
