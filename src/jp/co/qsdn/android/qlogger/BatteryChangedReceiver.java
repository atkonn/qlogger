...
public class BatteryChangedReceiver
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    if(action.equals("android.intent.action.BATTERY_CHANGED")) {
      ...
      contentValues.put(BatteryLogProvider.COLUMN_NAME.LEVEL,          intent.getIntExtra("level", 0));
      context.getContentResolver().insert(BatteryLogProvider.CONTENT_URI, contentValues);
      */
    }
  }
}
