  ...
  implements Parcelable
{
  ...
  public boolean equals(Object object) {
    if (!(object instanceof TempNetStatLog)) {
      return false;
    }
  ...
  private TempNetStatLog(Parcel in) {
    setId(in.readLong());
  ...
  public static final Parcelable.Creator<TempNetStatLog> CREATOR = new Parcelable.Creator<TempNetStatLog>() {
    public TempNetStatLog createFromParcel(Parcel in) {
      return new TempNetStatLog(in);
    }
    public TempNetStatLog[] newArray(int size) {
      return new TempNetStatLog[size];
    }
  };
