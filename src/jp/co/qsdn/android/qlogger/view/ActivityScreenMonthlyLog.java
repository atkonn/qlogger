...
public class ActivityScreenMonthlyLog
  extends AbstractActivity
{
  ...
  protected ListView setupListView(View view, int index) {
    ...
    final ArrayAdapter adapter = new ScreenMonthlyLogListAdapter(this, 0, getCurrentList(index));
  ...
  protected int getContentViewResourceId() {
    return R.layout.screenmonthlylog;
  }

  @Override
  protected int getTitleViewResourceId() {
    return R.layout.screenmonthlylog__action_bar;
  }
  ...
  protected ArrayList<ScreenMonthlyLog> currentList = new ArrayList<ScreenMonthlyLog>();
  protected List<ScreenMonthlyLog> getCurrentList(int startpos) {
    ...
    synchronized (currentList) {
      ...
      try {
        ...
        while (cur.moveToNext()) {
          ...
          currentList.add(screenMonthlyLog);
  ...
  public void gotoClear(View v) {
    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityScreenMonthlyLog.this);
    ...
    alertDialogBuilder.setPositiveButton(R.string.screenmonthlylog__button_of_delete_dialog_positive, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        Toast.makeText(ActivityScreenMonthlyLog.this, 
  ...
  public void gotoGraph(View v) {
    Intent intent = new Intent(this, ActivityScreenMonthlyLogGraph.class);
    intent.putExtra(EXTRA_PARAM.START_POS, getStartPos());
    startActivity(intent);
  }
  protected final static String SCREENLOGS_CSV = "screenmonthlylogs.csv";
  public void gotoSend(final View v) {
    ...
    try {
      ...
      synchronized(currentList) {
        int ii=0;
        for (ScreenMonthlyLog screenMonthlyLog: currentList) {
          if (ii==0) {
            out.write(screenMonthlyLog.toCsvTitle());
            out.write("\n");
            ii++;
          }
          out.write(screenMonthlyLog.toCsv());
          out.write("\n");
        }
        out.flush();
      };
