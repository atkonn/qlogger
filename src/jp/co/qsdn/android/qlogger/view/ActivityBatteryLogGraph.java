...
public class ActivityBatteryLogGraph
  extends AbstractActivity
{
  ...
  protected XYMultipleSeriesDataset getCurrentData(int startpos) {
    ...
    BatteryLog[] batteryLogs = (BatteryLog[])list.toArray(new BatteryLog[list.size()]);
    java.util.Calendar cal = java.util.Calendar.getInstance();
    cal.setTimeInMillis(batteryLogs[0].getTimestamp().getTime());
    ...
    for (int ii=0; ii<batteryLogs.length; ii++) {
      timeSeries.add(new java.util.Date(batteryLogs[ii].getTimestamp().getTime()), batteryLogs[ii].getLevel());
    }
  ...
  protected XYMultipleSeriesRenderer getRenderer() {
    ...
    renderer.setFillBelowLineColor(Color.parseColor("#158aea"));
  ...
  protected int getContentViewResourceId() {
    return R.layout.batterylog_graph;
  }

  @Override
  protected int getTitleViewResourceId() {
    return R.layout.batterylog__action_bar2;
  }
  ...
  public void gotoClear(View v) {
    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityBatteryLogGraph.this);
    ...
    alertDialogBuilder.setPositiveButton(R.string.batterylog__button_of_delete_dialog_positive, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        Toast.makeText(ActivityBatteryLogGraph.this, 
  ...
  protected final static String BATTERYLOGS_PNG = "batterylogs.png";
  public void gotoSend(final View v) {
    if (currentGraphBitmap == null) {
      AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityBatteryLogGraph.this);
      alertDialogBuilder.setTitle(getResources().getString(R.string.batterylog_graph__title_of_be_not_drawn_graph_yet));
      alertDialogBuilder.setMessage(getResources().getString(R.string.batterylog_graph__message_of_be_not_drawn_graph_yet));
      alertDialogBuilder.setPositiveButton(R.string.batterylog_graph__button_of_be_not_drawn_graph_yet, new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
          dialog.dismiss();
        }
