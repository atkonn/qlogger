...
import jp.co.qsdn.android.qlogger.view.adapter.ScreenLogListAdapter;
import jp.co.qsdn.android.qlogger.view.flipper.ViewFlipper;

public class ActivityScreenLog
  extends AbstractActivity
{
  ...
  protected String getTitleText() {
    return getResources().getString(R.string.dashboard_item_screenlog_title);
  }
...
Log.d(TAG, date);
  ...
  protected int getContentViewResourceId() {
    return R.layout.screenlog;
  }

  @Override
  protected int getTitleViewResourceId() {
    return R.layout.screenlog__action_bar;
  }
  ...
  protected ArrayList<ScreenLog> currentList = new ArrayList<ScreenLog>();
  protected List<ScreenLog> getCurrentList(int startpos) {
      ...
      try {
        cur = getContentResolver()
                       .query(ScreenLogProvider.CONTENT_URI, 
                         ...
                         ScreenLogProvider.COLUMN_NAME.YYYYMMDD + " = ? ",
                         new String[] {
                           yyyymmdd
                         },
                         ScreenLogProvider.COLUMN_NAME.CREATED_ON_LONG + " desc");
  ...
  protected void setupInitData() {
    ...
    try {
      cur = getContentResolver()
                    .query(ScreenLogProvider.CONTENT_URI_WITH_GROUPBY_YYYYMMDD,
                      new String[] {
                        ScreenLogProvider.COLUMN_NAME.YYYYMMDD
                      },
                      null,
  ...
  public void gotoClear(View v) {
    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityScreenLog.this);
    alertDialogBuilder.setTitle(getResources().getString(R.string.screenlog__title_of_delete_dialog));
    alertDialogBuilder.setMessage(getResources().getString(R.string.screenlog__message_of_delete_dialog));
    alertDialogBuilder.setPositiveButton(R.string.screenlog__button_of_delete_dialog_positive, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
        int result = getContentResolver().delete(ScreenLogProvider.CONTENT_URI, null, null);
        Toast.makeText(ActivityScreenLog.this, 
                       String.format(getResources().getString(R.string.screenlog__message_of_delete_completion), result), 
                       Toast.LENGTH_LONG).show();
        pagerFlipper.removeAllViews();
        onCreateBottomHalf();
      }
    });
    alertDialogBuilder.setNegativeButton(R.string.screenlog__button_of_delete_dialog_negative, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialog, int which) {
        dialog.dismiss();
      }
  ...
  public void gotoHistory(View v) {
    Intent intent = new Intent(this, ActivityScreenLogHistory.class);
    startActivity(intent);
  }
  protected final static String SCREENLOGS_CSV = "screenrawlogs.csv";
  public void gotoSend(final View v) {
    if (! getExternalStorageAvailable() || ! getExternalStorageWriteable()) {
      AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityScreenLog.this);
      alertDialogBuilder.setTitle(getResources().getString(R.string.screenlog__title_of_sdcard_error));
      alertDialogBuilder.setMessage(getResources().getString(R.string.screenlog__message_of_sdcard_error));
      alertDialogBuilder.setPositiveButton(R.string.screenlog__button_of_sdcard_error_ok, new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
          gotoSend(v);
          dialog.dismiss();
      ...
      alertDialogBuilder.setNegativeButton(R.string.screenlog__button_of_sdcard_error_negative, new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
          dialog.dismiss();
        }
    ...
    try {
      ...
      synchronized(currentList) {
        int ii=0;
        for (ScreenLog screenLog: currentList) {
          if (ii==0) {
            out.write(screenLog.toCsvTitle());
            out.write("\n");
            ii++;
          }
          out.write(screenLog.toCsv());
          out.write("\n");
        }
        out.flush();
      };
      ...
      AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityScreenLog.this);
      alertDialogBuilder.setTitle(getResources().getString(R.string.screenlog__title_of_file_output_error));
      alertDialogBuilder.setMessage(getResources().getString(R.string.screenlog__message_of_file_output_error));
      alertDialogBuilder.setPositiveButton(R.string.screenlog__button_of_file_output_error, new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
          dialog.dismiss();
        }
    ...
    try {
      ...
      AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityScreenLog.this);
      alertDialogBuilder.setTitle(getResources().getString(R.string.screenlog__title_of_zip_error));
      alertDialogBuilder.setMessage(getResources().getString(R.string.screenlog__message_of_zip_error));
      alertDialogBuilder.setPositiveButton(R.string.screenlog__button_of_zip_error, new DialogInterface.OnClickListener() {
        @Override
        public void onClick(DialogInterface dialog, int which) {
          dialog.dismiss();
        }
    ...
    intent.putExtra(Intent.EXTRA_SUBJECT,getResources().getString(R.string.screenlog__title_of_mail));
    intent.putExtra(Intent.EXTRA_TEXT, String.format(getResources().getString(R.string.screenlog__text_of_mail), dateList.get(getStartPos())));
    intent.putExtra(Intent.EXTRA_STREAM, Uri.parse("file://" + zipFilePath));
    intent.setType("application/zip");
    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    startActivity(Intent.createChooser(intent, getResources().getString(R.string.screenlog__message_of_client_chooser)));
  }
